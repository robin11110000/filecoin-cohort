...
contract SocialMediaContract {
    ...
    struct Post {
        uint id;
        string posthash; // This should be a Filecoin CID. 
                         // To get a CID, you can use a service like web3.storage or estuary.sh to upload your data to Filecoin.
        address payable author; // Author Address
        bool deleted; // Delete Status
        uint likes; // Post Likes
        uint postedAt; // TimeStamp
        string commentsHash; // This should be a Filecoin CID for the comments.
    }
